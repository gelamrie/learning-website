...
const Courses = () => {
    ...
    return (
        ...
        <div className='container mx-auto px-6 py-20'>
            ...
            <div className='mt-6 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 text-blue-500 text-sm font-medium'>
                ...
                {filteredCourses.map((course) => (
                    <div
                        ...
                        <div className='flex flex-wrap gap-2 mt-5'>
                            ...
                            {/* LEVEL */}
                            <span className='px-2.5 py-1 rounded-full bg-blue-500/10 text-blue-500 text-xs'>
                                {course.level}
                            </span>

                            {/* DURATION */}
                            <span className='px-2.5 py-1 rounded-full bg-neutral-200 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 text-xs'>
                                {course.duration}
                            </span>
